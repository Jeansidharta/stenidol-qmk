...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [QWERTY_2] = LAYOUT(
        ...
        KC_F12,  KC_F3,   KC_F2, KC_F1, XXXXXXX,
    ...
    [QWERTY_3] = LAYOUT(
        ...
        KC_SLSH, KC_1, KC_2,    KC_3,    KC_GRV,
                       KC_TRNS, KC_TRNS, MO(QWERTY_4),

        // right
        KC_WH_U, XXXXXXX, KC_MS_U, KC_RBRC, KC_LBRC,
        KC_WH_D, KC_MS_R, KC_MS_D, KC_MS_L, KC_QUOT,
        KC_BTN5, KC_BTN4, KC_BTN3, KC_BTN2, KC_BTN1,
        _______, _______, _______
    ),
    [QWERTY_4] = LAYOUT(
        // left
